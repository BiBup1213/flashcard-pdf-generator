...
Optional (empfohlen): Virtuelle Umgebung nutzen
...
- Output kurz durchgehen (Dopplungen entfernen, zu lange Antworten kürzen)
- ins JSON übernehmen
- PDF generieren
...
Aktuell bleibt es bewusst bei der Kernfunktion:

**JSON → druckbare Karteikarten-PDF**
